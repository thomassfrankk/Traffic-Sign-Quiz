...
final class CountryDataEntity {
    ...
    // Convenience initializer for automatic UUID
    init(
        id: String? = nil,
        country: String,
        drivingSide: String,
...
final class TrafficSignEntity {
    ...
    func getTranslatableContent(from sourceLanguage: String, sectionIndex: Int, subsectionIndex: Int?, signIndex: Int) -> [(text: String, type: String, subsectionIndex: Int?, signIndex: Int, wrongAnswerIndex: Int?)] {
        ...
        // Section name
        if !signLanguage.sectionName.isEmpty {
            items.append((text: signLanguage.sectionName, type: "\(typePrefix)-section-name", subsectionIndex: subsectionIndex, signIndex: signIndex, wrongAnswerIndex: nil))
        }
        
        // Subsection name (if applicable)
        if let subSectionName = signLanguage.subSectionName, !subSectionName.isEmpty {
            items.append((text: subSectionName, type: "\(typePrefix)-subsection-name", subsectionIndex: subsectionIndex, signIndex: signIndex, wrongAnswerIndex: nil))
        }
...
//    let speedLimits: SpeedLimitsDTO
//    let lastUpdated: Date
//    let language: [String: CountryLanguageContent]
//    let sections: [TrafficSectionDTO]?
//}
//
//struct TrafficSectionDTO: Codable {
//    var id: String?       // ← optional now
//    let index: Int
//    let language: [String: SectionLanguageContent]
//    let subSections: [TrafficSubSectionDTO]?
//    let signs: [TrafficSignDTO]
//}
//
//struct TrafficSubSectionDTO: Codable {
//    var id: String?       // ← optional now
//    let index: Int
//    let language: [String: SubsectionLanguageContent]
//    let signs: [TrafficSignDTO]
//}
//
//struct TrafficSignDTO: Codable {
//    var id: String?       // ← optional now
//    let index: Int
//    let difficulty: Int
//    let imageData: [Data]
//    let language: [String: SignLanguageContent]
//}
//
//extension CountryDataEntity {
//    convenience init(from dto: CountryDTO) {
//        let speedLimitsEntity = SpeedLimits(
//            urban: dto.speedLimits.urban,
//            rural: dto.speedLimits.rural,
//            motorway: dto.speedLimits.motorway
//        )
//        
//        self.init(
//            id: dto.id ?? UUID().uuidString,
//            country: dto.country,
//            drivingSide: dto.drivingSide,
//            alcoholLimit: dto.alcoholLimit,
//            alcoholUnit: dto.alcoholUnit,
//            emergencyNumber: dto.emergencyNumber,
//            currency: dto.currency,
//            speedUnit: dto.speedUnit,
//            speedLimits: speedLimitsEntity,
//            lastUpdated: dto.lastUpdated,
//            language: dto.language,
//            sections: dto.sections?.map { TrafficSectionEntity(from: $0) } ?? []
//        )
//    }
//}
//
//extension TrafficSectionEntity {
//    convenience init(from dto: TrafficSectionDTO) {
//        self.init(
//            id: dto.id ?? UUID().uuidString,
//            index: dto.index,
//            language: dto.language,
//            subSections: dto.subSections?.map { TrafficSubSectionEntity(from: $0) },
//            signs: dto.signs.map { TrafficSignEntity(from: $0) }
//        )
//    }
//}
//
//extension TrafficSubSectionEntity {
//    convenience init(from dto: TrafficSubSectionDTO) {
//        self.init(
//            id: dto.id ?? UUID().uuidString,
//            index: dto.index,
//            language: dto.language,
...
//}
//
//extension TrafficSignEntity {
//    convenience init(from dto: TrafficSignDTO) {
//        self.init(
//            id: dto.id ?? UUID().uuidString,
//            index: dto.index,
